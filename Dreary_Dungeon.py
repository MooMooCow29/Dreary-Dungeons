#importing pygame, 
#importing asyncio - asyncio is a library to write concurrent code using the async/await syntax.
#importign math - for mathimatical taks
import pygame
import asyncio
import math
#importing other scripts into this to incoporate features
...
class Game:
    ...
    def __init__(self):
        ...
        self.running = True
        pygame.display.set_caption("Dreary dungeons")
        ...
        self.tut_text1 = self.regularText.render("WD to move", False, (255, 255, 255))
...
#draw the circle for the player by coparignt the 
